...
#define STAGESTAT_DONE          3
#define STAGESTAT_START         2
#define STAGESTAT_BUSY          1
#define STAGESTAT_WAITINGFORINT 0
#define STAGESTAT_BADTIMING     -1
#define STAGESTAT_BADDATA       -2
#define STAGESTAT_BADINTERRUPT  -3
#define STAGESTAT_BADMIRROR     -4
#define STAGESTAT_BADGRAPHICS   -5
