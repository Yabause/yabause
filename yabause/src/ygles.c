...
void YglRenderVDP1(void) {
  ...
  if (Vdp1Regs->TVMR & 0x02) {
    ...
    translate.m[0][3] = -Vdp1ParaA.Xst;
    translate.m[1][3] = -Vdp1ParaA.Yst;
    translate.m[2][3] = 0.0;
    YglMatrixMultiply(&m, &rotate, &translate); //Might be requested to swap
    YglMatrixMultiply(&m, &m, mat);
