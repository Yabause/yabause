...
{
	CFDictionaryRef BSDMatchDictionary = IOBSDNameMatching(kIOMasterPortDefault, 0, BSDDeviceName);
	io_object_t media = IOServiceGetMatchingService(kIOMasterPortDefault, BSDMatchDictionary);
	CDTOC *TOC;
