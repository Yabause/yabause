        ...
        for (i = 0; tab[i].mnem != NULL; i++)   /* 0 format */
        {
                if ((op & tab[i].mask) == tab[i].bits)
                {
                        if (tab[i].sh2 && mode) /* if SH-1 mode, no SH-2 */
                                sprintf(chaine,"unrecognized");
                        else if (tab[i].format == ZERO_F)
                                sprintf(chaine,"%s", tab[i].mnem);
                        else if (tab[i].format == N_F)
                                sprintf(chaine,tab[i].mnem, (op >> 8) & 0xf);
                        else if (tab[i].format == M_F)
                                sprintf(chaine,tab[i].mnem, (op >> 8) & 0xf);
                        else if (tab[i].format == NM_F)
                                sprintf(chaine,tab[i].mnem, (op >> 4) & 0xf,
                                                    (op >> 8) & 0xf);
                        else if (tab[i].format == MD_F)
                        {
                                if (op & 0x100)
                                        sprintf(chaine,tab[i].mnem, (op & 0xf) * 2,
                                                            (op >> 4) & 0xf);
                                else
                                        sprintf(chaine,tab[i].mnem, op & 0xf,
                                                            (op >> 4) & 0xf);
                        }
                        ...
                        else if (tab[i].format == NMD_F)
                        {
                                if ((op & 0xf000) == 0x1000)
                                        ...
                                        sprintf(chaine,tab[i].mnem, (op & 0xf) * 4,
                                                            (op >> 4) & 0xf,
                                                            (op >> 8) & 0xf);
                        }
                        ...
                        else if (tab[i].format == D12_F)
                        {
                                if (op & 0x800)         /* sign extend */
                                        ...
                                        sprintf(chaine,tab[i].mnem, (op & 0xfff) * 2 +
                                               v_addr + 4);
                        }
                        else if (tab[i].format == ND8_F)
                        {
                                ...
                                sprintf(chaine,tab[i].mnem, op & 0xff);
                        else if (tab[i].format == NI_F)
                                sprintf(chaine,tab[i].mnem, op & 0xff, (op >> 8) &
                                                               0xf);
                        else
                                sprintf(chaine,"unrecognized");
                        return;
