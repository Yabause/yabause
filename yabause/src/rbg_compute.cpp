...
" int GetKValue( int paramid, float posx, float posy, out float ky){ \n"
"  uint kdata;\n"
...
"	   if((kdata&0x00800000u)!=0u) ky=float( int(kdata&0x00FFFFFFu)| int(0xFF800000u) )/65536.0;\n"
"    else ky=float(kdata&0x00FFFFFFu)/65536.0;\n"
"  }\n"
"  return 0;\n"
" }\n"
...
"  paramid = 0; \n"
"  ky = para[paramid].ky; \n"
"  if( para[paramid].coefenab != 1 ){ \n"
"   if( GetKValue(paramid,posx,posy,ky ) == -1 ) { imageStore(outSurface,texel,vec4(0.0)); return;} \n"
"  }\n";
...
"  ky = para[paramid].ky; \n"
"  if( para[paramid].coefenab != 0 ){ \n"
"    if( GetKValue(paramid,posx,posy,ky ) == -1 ) { \n"
"      paramid=1;\n"
"      if( para[paramid].coefenab != 0 ){ \n"
"        if( GetKValue(paramid,posx,posy,ky ) == -1 ) { imageStore(outSurface,texel,vec4(0.0)); return;} \n"
"      }else{ \n"
