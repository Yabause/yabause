...
TEST_F(StsTest, stsmach) {
  ...
  SH2MappedMemoryWriteWord( 0x0600024c, 0x030A );
  SH2MappedMemoryWriteWord( 0x0600024e, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000250, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000260, 0xDEADDEAD );  // nop
...
TEST_F(StsTest, stsmmach) {
  ...
  SH2MappedMemoryWriteWord( 0x0600024c, 0x4302 );
  SH2MappedMemoryWriteWord( 0x0600024e, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000250, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000260, 0xDEADDEAD );  // nop
...
TEST_F(StsTest, stsmacl) {
  ...
  SH2MappedMemoryWriteWord( 0x0600024c, 0x031A );
  SH2MappedMemoryWriteWord( 0x0600024e, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000250, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000260, 0xDEADDEAD );  // nop
...
TEST_F(StsTest, stsmmacl) {
  ...
  SH2MappedMemoryWriteWord( 0x0600024c, 0x4312 );
  SH2MappedMemoryWriteWord( 0x0600024e, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000250, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000260, 0xDEADDEAD );  // nop
...
TEST_F(StsTest, stspr) {
  ...
  SH2MappedMemoryWriteWord( 0x0600024c, 0x032A );
  SH2MappedMemoryWriteWord( 0x0600024e, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000250, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000260, 0xDEADDEAD );  // nop
