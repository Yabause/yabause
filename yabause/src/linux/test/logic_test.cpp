...
TEST_F(LogicTest, and) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0x2329 );
...
TEST_F(LogicTest, andi) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xC929 );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, andb) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xCD29 );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000250, 0xDEADCAFE );  // nop

  MSH2->regs.PC =( 0x06000000 );
  SH2TestExec(MSH2, 1);

  EXPECT_EQ( 0x08ADCAFE, SH2MappedMemoryReadLong(0x06000250) );
}
...
TEST_F(LogicTest, not) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0x6107 );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, or) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0x210B );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, ori) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xCB1B );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, origbr) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xCF1B );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000250, 0xDEADCAFE );  // nop
  ...
  EXPECT_EQ( 0xDFADCAFE, SH2MappedMemoryReadLong(0x06000250) );
}
...
TEST_F(LogicTest, tasb) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0x411B );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000250, 0x00ADDEAD );  // nop

  MSH2->regs.PC =( 0x06000000 );
  SH2TestExec(MSH2, 1);

  EXPECT_EQ( 0x80ADDEAD, SH2MappedMemoryReadLong(0x06000250) );
  ...
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000250, 0x07ADDEAD );  // nop

  MSH2->regs.PC =( 0x06000000 );
  SH2TestExec(MSH2, 1);

  EXPECT_EQ( 0x87ADDEAD, SH2MappedMemoryReadLong(0x06000250) );
...
TEST_F(LogicTest, tst) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0x2108 );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, tsti) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xC825 );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xC822 );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, tstb) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xCC25 );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000250, 0x42ADDEAD );

  MSH2->regs.PC =( 0x06000000 );
  SH2TestExec(MSH2, 1);

  EXPECT_EQ( 0xE1, MSH2->regs.SR.all );
  EXPECT_EQ( 0x42ADDEAD, SH2MappedMemoryReadLong(0x06000250) );
  ...
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000250, 0x62ADDEAD );

  MSH2->regs.PC =( 0x06000000 );
  SH2TestExec(MSH2, 1);

  EXPECT_EQ( 0xE0, MSH2->regs.SR.all );
  EXPECT_EQ( 0x62ADDEAD, SH2MappedMemoryReadLong(0x06000250) );
}
...
TEST_F(LogicTest, xor) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0x210A );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, xori) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xCA1B );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xCA9B );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
...
TEST_F(LogicTest, xorigbr) {
  ...
  SH2MappedMemoryWriteWord( 0x06000000, 0xCE1B );
  SH2MappedMemoryWriteWord( 0x06000002, 0x000b );  // rts
  SH2MappedMemoryWriteWord( 0x06000004, 0x0009 );  // nop
  SH2MappedMemoryWriteLong( 0x06000250, 0xF0F0F2F0 );  // nop

  MSH2->regs.PC =( 0x06000000 );
  SH2TestExec(MSH2, 1);

  EXPECT_EQ( 0xEBF0F2F0, SH2MappedMemoryReadLong(0x06000250) );
}
