...
//0602E3C4: MACL R[6]=06001F04@FFFB60F6,R[7]=06030064@00007421,MACH=00000001,MACL=7EE9BBB6
  ...
  MappedMemoryWriteLong( 0x06001F04, 0xFFFB60F6 );
  MappedMemoryWriteLong( 0x06030064, 0x00007421 );

  // mac.l @r7+, @r6+
  MappedMemoryWriteWord( 0x06000000, 0x067F );
...
// 0602e3c2: maclo 0x067f MACL 0xfd6f8ca0 MACH 0xfffffffc
  ...
  MappedMemoryWriteLong( 0x06001F04, 0x00036420 );
  MappedMemoryWriteLong( 0x060300c0, 0xffff1cc5 );
