...
TEST_F(RteTest, normal) {
  ...
  MappedMemoryWriteLong( 0x06001F68, 0x060107B6 );
  MappedMemoryWriteLong( 0x06001F6C, 0x0 );
  MSH2->regs.SR.all =(0);

  // rte
  MappedMemoryWriteWord( 0x06000000, 0x002b );
...
TEST_F(RteTest, rts) {
  ...
  // rts
  MappedMemoryWriteWord( 0x0600024c, 0x000b );
