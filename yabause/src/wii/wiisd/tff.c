...
BOOL next_dir_entry (	/* TRUE: successful, FALSE: could not move next */
  DIRECTORY *dirobj			/* Pointer to directory object */
)
{
  CLUST clust;
  WORD idx;
...
FRESULT trace_path (	/* FR_OK(0): successful, !=0: error code */
  DIRECTORY *dirobj,		/* Pointer to directory object to return last directory */
...
FRESULT reserve_direntry (	/* FR_OK: successful, FR_DENIED: no free entry, FR_RW_ERROR: a disk error occured */
  DIRECTORY *dirobj,			/* Target directory to create new entry */
...
FRESULT f_opendir (
  DIRECTORY *dirobj,		/* Pointer to directory object to create */
...
FRESULT f_readdir (
  DIRECTORY *dirobj,		/* Pointer to the directory object */
