...
import org.uoyabause.android.cheat.CloudCheatItemFragment.OnListFragmentInteractionListener;
 ...
 */
public class CloudCheatItemRecyclerViewAdapter extends RecyclerView.Adapter<CloudCheatItemRecyclerViewAdapter.ViewHolder> {

    private final List<CheatItem> mValues;
    private int focusedItem = 0;

    public CloudCheatItemRecyclerViewAdapter(List<CheatItem> items, OnItemClickListener listener) {
        mValues = items;
        mListener = listener;
    }
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (event.getAction() == KeyEvent.ACTION_DOWN) {
                    if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN) {
                        ...
                        if( mListener != null) {
                            CloudCheatItemRecyclerViewAdapter.ViewHolder holder = (CloudCheatItemRecyclerViewAdapter.ViewHolder)recyclerView.findViewHolderForAdapterPosition(focusedItem);
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.mRate.setRating((float)holder.mItem.getStarCount());

        holder.mRateScore.setText( String.format("%.1f",(float)holder.mItem.getStarCount()) );
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            mRate = (RatingBar)view.findViewById(R.id.ratingBar);
            mRateScore = (TextView)view.findViewById(R.id.textView_rate);
        }
