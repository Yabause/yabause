...
public class InputSettingPreferenceFragment extends PreferenceDialogFragmentCompat
        implements DialogInterface.OnKeyListener, OnGenericMotionListener, OnClickListener{
  ...
  public InputSettingPreferenceFragment() {

  }

  public static InputSettingPreferenceFragment newInstance(String key) {
    InputSettingPreferenceFragment fragment = new InputSettingPreferenceFragment();
  ...
  void InitObjects(  AlertDialog.Builder builder ) {
    index = 0;
    ...
    //DialogPreference dialog = getPreference();
    //dialog.setDialogTitle(R.string.input_the_key);
    //dialog.setPositiveButtonText(null);  // OKボタンを非表示にする
    //dialog.setDialogLayoutResource(R.layout.keymap);
  ...
  public Dialog onCreateDialog (Bundle savedInstanceState){
    ...
    InputSettingPreference is = (InputSettingPreference)getPreference();
  ...
  public void saveSettings() {
    ...
    try {
      ...
      // jsonファイル出力
      InputSettingPreference is = (InputSettingPreference)getPreference();
      File file = new File(YabauseStorage.getStorage().getRootPath() ,is.getSave_filename() + ".json");
