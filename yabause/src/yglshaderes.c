...
const GLchar Yglprg_vdp2_drawfb_cram_msb_color_col_f[]   = " if( fragColor.a != 0.0 ){ fragColor.a = 1.0 - u_alpha[((additional>>3)&0x07)]; }else{ fragColor.a = 1.0; } \n ";
...
"  fragColor = (lncol*fragColor.a) + fragColor*(1.0-fragColor.a); \n";
