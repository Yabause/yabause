...
"  if (u_coloroffset_sign.r != 0.0) u_coloroffset.r = 1.0-u_coloroffset.r+1.0/255.0;\n"
"  if (u_coloroffset_sign.g != 0.0) u_coloroffset.g = 1.0-u_coloroffset.g+1.0/255.0;\n"
"  if (u_coloroffset_sign.b != 0.0) u_coloroffset.b = 1.0-u_coloroffset.b+1.0/255.0;\n"
