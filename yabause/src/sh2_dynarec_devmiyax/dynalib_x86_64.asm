...
opdesc MOVBL0,	38,6,31,0xff,0xff,0xff
opfunc MOVBL0
mov rbp,rdi          ;2
add rbp,byte $00     ;3
mov ecx,[rbp]        ;3
...
opdesc MOVWL0,	36,6,31,0xff,0xff,0xff
opfunc MOVWL0
mov rbp,rdi          ;2
add rbp,byte $00     ;3
mov ecx,[rbp]        ;3
...
opdesc MOVLL0,	35,6,31,0xff,0xff,0xff
opfunc MOVLL0
mov rbp,rdi          ;2
add rbp,byte $00     ;3
mov ecx,[rbp]        ;3
...
opdesc DT,		22,0xff,6,0xff,0xff,0xff
opfunc DT
mov rbp,rdi         ;2
add rbp,byte $00    ;3
and dword [rbx],byte 0xfe ;3
...
opdesc ROTL,	25,0xff,6,0xff,0xff,0xff
opfunc ROTL
mov rbp,rdi               ;2
add rbp,byte $00          ;3
mov eax,[rbp]             ;2
...
opdesc ROTR,	27,0xff,6,0xff,0xff,0xff
opfunc ROTR
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbp]       ;2
...
opdesc ROTCL,	32,0xff,6,0xff,0xff,0xff
opfunc ROTCL
mov rbp,rdi         ;2
add rbp,byte $00    ;3
mov eax,[rbx]       ;2
