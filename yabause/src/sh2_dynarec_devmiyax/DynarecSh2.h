...
public:
  ...
  inline void setDirty(u32 addr)
  {
    ...
    if (LookupParentTable[addr].size() == 0)
      return;
  ...
  int overrideMemFunc(void *ptr, int func);
...
extern "C"
{
  ...
  void memSetByteNoCache(u32, u8);
  void memSetWordNoCache(u32, u16);
  void memSetLongNoCache(u32, u32);
