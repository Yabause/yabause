...
"vec4 VDP1COLOR(uint endTag, uint CMDCOLR) {\n"
"  return vec4(float((CMDCOLR>>0)&0xFFu)/255.0,float((CMDCOLR>>8)&0xFFu)/255.0,float((endTag>>0)&0xFFu)/255.0,float((endTag>>8)&0xFFu)/255.0);\n"
"}\n"
...
"       else dot = (dot)&0xFu;\n"
"      if ((dot == 0x0Fu) && !END) endTag = 0xFF;\n"
"      if ((dot == 0) && !SPD) color = VDP1COLOR(endTag, 0x00);\n"
"      else color = VDP1COLOR(endTag, dot | colorBank);\n"
"      break;\n"
"    }\n"
"    case 1:\n"
"    {\n"
...
"      dot = Vdp1RamReadByte(charAddr);\n"
"      if ((dot == 0xFFu) && !END) endTag = 0xFF;\n"
"      if ((dot == 0) && !SPD) color = VDP1COLOR(endTag, 0x00);\n"
"      else {\n"
"        color = VDP1COLOR(endTag, (dot & 0x3Fu) | colorBank);\n"
"      }\n"
"      break;\n"
"    }\n"
"    case 3:\n"
...
"      if ((dot == 0) && !SPD) color = VDP1COLOR(endTag, 0x00);\n"
"      else {\n"
"        color = VDP1COLOR(endTag, (dot & 0x7Fu) | colorBank);\n"
"      }\n"
"      break;\n"
"    }\n"
"    case 4:\n"
...
"      if ((dot == 0) && !SPD) color = VDP1COLOR(endTag, 0x00);\n"
"      else {\n"
"          color = VDP1COLOR(endTag, dot | colorBank);\n"
"      }\n"
"      break;\n"
"    }\n"
"    case 5:\n"
...
"      if ((temp == 0x7FFFu) && !END) endTag = 0xFF;\n"
"      if (((temp & 0x8000u) == 0) && !SPD) color = VDP1COLOR(endTag, 0x00);\n"
"      else {\n"
"        color = VDP1COLOR(endTag, temp);\n"
"      }\n"
"      break;\n"
