...
#define VDP1_COLOR_CL_MSB_SHADOW 0X26
...
enum
{
   ...
   PG_VFP1_HALF_LUMINANCE=11,
   PG_VFP1_MESH=12,
   PG_VDP2_ADDBLEND=13,
   PG_WINDOW=14,
   PG_LINECOLOR_INSERT=15,
   PG_LINECOLOR_INSERT_CRAM=16,
   PG_LINECOLOR_INSERT_DESTALPHA=17,
   PG_LINECOLOR_INSERT_DESTALPHA_CRAM=18,
   PG_VDP2_BLUR=19,
   PG_VDP2_MOSAIC=20,
   PG_VDP2_PER_LINE_ALPHA=21,
   PG_VDP2_NORMAL_CRAM=22,
   ...
   PG_VFP1_GOURAUDSAHDING_TESS=52,
   PG_VFP1_GOURAUDSAHDING_HALFTRANS_TESS=53,
   PG_VFP1_MESH_TESS=54,
   PG_VFP1_SHADOW_TESS=55,
   PG_VFP1_GOURAUDSAHDING_SPD_TESS=56,
   PG_VFP1_HALFTRANS_TESS=57,
