...
enum
{
   PG_VDP1_STARTUSERCLIP=1,
   PG_VDP1_ENDUSERCLIP=2,

   //VDP1 Programs
   PG_VDP1_REPLACE=3,
   PG_VDP1_SHADOW=4,
   PG_VDP1_HALF_LUMINANCE=5,
   PG_VDP1_HALFTRANS=6,
   PG_VDP1_GOURAUDSHADING=7,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE=8,
   PG_VDP1_GOURAUDSHADING_HALFTRANS=9,
   PG_VDP1_MSB_SHADOW=10,

   //VDP1 Programs with mesh
   PG_VDP1_REPLACE_MESH=11,
   PG_VDP1_SHADOW_MESH=12,
   PG_VDP1_HALF_LUMINANCE_MESH=13,
   PG_VDP1_HALFTRANS_MESH=14,
   PG_VDP1_GOURAUDSHADING_MESH=15,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH=16,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH=17,
   PG_VDP1_MSB_SHADOW_MESH=18,

   //VDP1 Programs with improved mesh
   PG_VDP1_REPLACE_MESH_IMPROVE=19,
   PG_VDP1_SHADOW_MESH_IMPROVE=20,
   PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE=21,
   PG_VDP1_HALFTRANS_MESH_IMPROVE=22,
   PG_VDP1_GOURAUDSHADING_MESH_IMPROVE=23,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_IMPROVE=24,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_IMPROVE=25,
   PG_VDP1_MSB_SHADOW_MESH_IMPROVE=26,

   //VDP1 Programs with MSB
   PG_VDP1_REPLACE_MSB=27,
   PG_VDP1_SHADOW_MSB=28,
   PG_VDP1_HALF_LUMINANCE_MSB=29,
   PG_VDP1_HALFTRANS_MSB=30,
   PG_VDP1_GOURAUDSHADING_MSB=31,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MSB=32,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MSB=33,
   PG_VDP1_MSB_SHADOW_MSB=34,
   PG_VDP1_MESH_MSB=35,
   PG_VDP1_MESH_IMPROVE_MSB=36,

   PG_VDP1_REPLACE_MESH_MSB=37,
   PG_VDP1_SHADOW_MESH_MSB=38,
   PG_VDP1_HALF_LUMINANCE_MESH_MSB=39,
   PG_VDP1_HALFTRANS_MESH_MSB=40,
   PG_VDP1_GOURAUDSHADING_MESH_MSB=41,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_MSB=42,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_MSB=43,
   PG_VDP1_MSB_SHADOW_MESH_MSB=44,

   PG_VDP1_REPLACE_MESH_IMPROVE_MSB=45,
   PG_VDP1_SHADOW_MESH_IMPROVE_MSB=46,
   PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE_MSB=47,
   PG_VDP1_HALFTRANS_MESH_IMPROVE_MSB=48,
   PG_VDP1_GOURAUDSHADING_MESH_IMPROVE_MSB=49,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_IMPROVE_MSB=50,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_IMPROVE_MSB=51,
   PG_VDP1_MSB_SHADOW_MESH_IMPROVE_MSB=52,

   //VDP1 Programs in case of TESSELATION.
   //SHALL HAVE THE SAME ORDER THAN VDP1 STD PROGRAMME
   //VDP1 Programs
      PG_VDP1_REPLACE_TESS=53,
      PG_VDP1_SHADOW_TESS=54,
      PG_VDP1_HALF_LUMINANCE_TESS=55,
      PG_VDP1_HALFTRANS_TESS=56,
      PG_VDP1_GOURAUDSHADING_TESS=57,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_TESS=58,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_TESS=59,
      PG_VDP1_MSB_SHADOW_TESS=60,
      PG_VDP1_MESH_TESS=61,
      PG_VDP1_MESH_IMPROVE_TESS=62,

      //VDP1 Programs with mesh
      PG_VDP1_REPLACE_MESH_TESS=63,
      PG_VDP1_SHADOW_MESH_TESS=64,
      PG_VDP1_HALF_LUMINANCE_MESH_TESS=65,
      PG_VDP1_HALFTRANS_MESH_TESS=66,
      PG_VDP1_GOURAUDSHADING_MESH_TESS=67,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_TESS=68,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_TESS=69,
      PG_VDP1_MSB_SHADOW_MESH_TESS=70,

      //VDP1 Programs with improved mesh
      PG_VDP1_REPLACE_MESH_IMPROVE_TESS=71,
      PG_VDP1_SHADOW_MESH_IMPROVE_TESS=72,
      PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE_TESS=73,
      PG_VDP1_HALFTRANS_MESH_IMPROVE_TESS=74,
      PG_VDP1_GOURAUDSHADING_MESH_IMPROVE_TESS=75,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_IMPROVE_TESS=76,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_IMPROVE_TESS=77,
      PG_VDP1_MSB_SHADOW_MESH_IMPROVE_TESS=78,

      //VDP1 Programs with MSB
      PG_VDP1_REPLACE_MSB_TESS=79,
      PG_VDP1_SHADOW_MSB_TESS=80,
      PG_VDP1_HALF_LUMINANCE_MSB_TESS=81,
      PG_VDP1_HALFTRANS_MSB_TESS=82,
      PG_VDP1_GOURAUDSHADING_MSB_TESS=83,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MSB_TESS=84,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MSB_TESS=85,
      PG_VDP1_MSB_SHADOW_MSB_TESS=86,
      PG_VDP1_MESH_MSB_TESS=87,
      PG_VDP1_MESH_IMPROVE_MSB_TESS=88,

      PG_VDP1_REPLACE_MESH_MSB_TESS=89,
      PG_VDP1_SHADOW_MESH_MSB_TESS=90,
      PG_VDP1_HALF_LUMINANCE_MESH_MSB_TESS=91,
      PG_VDP1_HALFTRANS_MESH_MSB_TESS=92,
      PG_VDP1_GOURAUDSHADING_MESH_MSB_TESS=93,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_MSB_TESS=94,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_MSB_TESS=95,
      PG_VDP1_MSB_SHADOW_MESH_MSB_TESS=96,

      PG_VDP1_REPLACE_MESH_IMPROVE_MSB_TESS=97,
      PG_VDP1_SHADOW_MESH_IMPROVE_MSB_TESS=98,
      PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE_MSB_TESS=99,
      PG_VDP1_HALFTRANS_MESH_IMPROVE_MSB_TESS=100,
      PG_VDP1_GOURAUDSHADING_MESH_IMPROVE_MSB_TESS=101,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_IMPROVE_MSB_TESS=102,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_IMPROVE_MSB_TESS=103,
      PG_VDP1_MSB_SHADOW_MESH_IMPROVE_MSB_TESS=104,
