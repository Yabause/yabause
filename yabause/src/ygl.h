...
enum
{
   ...
   PG_VDP1_REPLACE_MESH=10,
   PG_VDP1_SHADOW_MESH=11,
   PG_VDP1_HALF_LUMINANCE_MESH=12,
   PG_VDP1_HALFTRANS_MESH=13,
   PG_VDP1_GOURAUDSHADING_MESH=14,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH=15,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH=16,

   //VDP1 Programs with improved mesh
   PG_VDP1_REPLACE_MESH_IMPROVE=17,
   PG_VDP1_SHADOW_MESH_IMPROVE=18,
   PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE=19,
   PG_VDP1_HALFTRANS_MESH_IMPROVE=20,
   PG_VDP1_GOURAUDSHADING_MESH_IMPROVE=21,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_IMPROVE=22,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_IMPROVE=23,

   //VDP1 Programs with MSB
   PG_VDP1_REPLACE_MSB=24,
   PG_VDP1_SHADOW_MSB=25,
   PG_VDP1_HALF_LUMINANCE_MSB=26,
   PG_VDP1_HALFTRANS_MSB=27,
   PG_VDP1_GOURAUDSHADING_MSB=28,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MSB=29,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MSB=30,

   PG_VDP1_REPLACE_MESH_MSB=31,
   PG_VDP1_SHADOW_MESH_MSB=32,
   PG_VDP1_HALF_LUMINANCE_MESH_MSB=33,
   PG_VDP1_HALFTRANS_MESH_MSB=34,
   PG_VDP1_GOURAUDSHADING_MESH_MSB=35,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_MSB=36,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_MSB=37,

   PG_VDP1_REPLACE_MESH_IMPROVE_MSB=38,
   PG_VDP1_SHADOW_MESH_IMPROVE_MSB=39,
   PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE_MSB=40,
   PG_VDP1_HALFTRANS_MESH_IMPROVE_MSB=41,
   PG_VDP1_GOURAUDSHADING_MESH_IMPROVE_MSB=42,
   PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_IMPROVE_MSB=43,
   PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_IMPROVE_MSB=44,

   //VDP1 Programs in case of TESSELATION.
   //SHALL HAVE THE SAME ORDER THAN VDP1 STD PROGRAMME
   //VDP1 Programs
      PG_VDP1_REPLACE_TESS=45,
      PG_VDP1_SHADOW_TESS=46,
      PG_VDP1_HALF_LUMINANCE_TESS=47,
      PG_VDP1_HALFTRANS_TESS=48,
      PG_VDP1_GOURAUDSHADING_TESS=49,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_TESS=50,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_TESS=51,

      //VDP1 Programs with mesh
      PG_VDP1_REPLACE_MESH_TESS=52,
      PG_VDP1_SHADOW_MESH_TESS=53,
      PG_VDP1_HALF_LUMINANCE_MESH_TESS=54,
      PG_VDP1_HALFTRANS_MESH_TESS=55,
      PG_VDP1_GOURAUDSHADING_MESH_TESS=56,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_TESS=57,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_TESS=58,

      //VDP1 Programs with improved mesh
      PG_VDP1_REPLACE_MESH_IMPROVE_TESS=59,
      PG_VDP1_SHADOW_MESH_IMPROVE_TESS=60,
      PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE_TESS=61,
      PG_VDP1_HALFTRANS_MESH_IMPROVE_TESS=62,
      PG_VDP1_GOURAUDSHADING_MESH_IMPROVE_TESS=63,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_IMPROVE_TESS=64,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_IMPROVE_TESS=65,

      //VDP1 Programs with MSB
      PG_VDP1_REPLACE_MSB_TESS=66,
      PG_VDP1_SHADOW_MSB_TESS=67,
      PG_VDP1_HALF_LUMINANCE_MSB_TESS=68,
      PG_VDP1_HALFTRANS_MSB_TESS=69,
      PG_VDP1_GOURAUDSHADING_MSB_TESS=70,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MSB_TESS=71,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MSB_TESS=72,

      PG_VDP1_REPLACE_MESH_MSB_TESS=73,
      PG_VDP1_SHADOW_MESH_MSB_TESS=74,
      PG_VDP1_HALF_LUMINANCE_MESH_MSB_TESS=75,
      PG_VDP1_HALFTRANS_MESH_MSB_TESS=76,
      PG_VDP1_GOURAUDSHADING_MESH_MSB_TESS=77,
      PG_VDP1_GOURAUDSHADING_HALF_LUMINANCE_MESH_MSB_TESS=78,
      PG_VDP1_GOURAUDSHADING_HALFTRANS_MESH_MSB_TESS=79,

      PG_VDP1_REPLACE_MESH_IMPROVE_MSB_TESS=80,
      PG_VDP1_SHADOW_MESH_IMPROVE_MSB_TESS=81,
      PG_VDP1_HALF_LUMINANCE_MESH_IMPROVE_MSB_TESS=82,
      PG_VDP1_HALFTRANS_MESH_IMPROVE_MSB_TESS=83,
      PG_VDP1_GOURAUDSHADING_MESH_IMPROVE_MSB_TESS=84,
