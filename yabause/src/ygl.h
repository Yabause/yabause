...
enum
{
   ...
   PG_VDP1_GOURAUDSHADING_SPD=3,
   PG_VDP1_STARTUSERCLIP=4,
   PG_VDP1_ENDUSERCLIP=5,
   PG_VDP1_HALFTRANS=6,
   PG_VDP1_SHADOW=7,
   PG_VDP1_MSB_SHADOW=8,
   PG_VDP1_GOURAUDSHADING_HALFTRANS=9,
   PG_VDP1_HALF_LUMINANCE=10,
   PG_VDP1_MESH=11,
   PG_VDP2_ADDBLEND=12,
   PG_WINDOW=13,
   ...
   PG_VDP1_GOURAUDSHADING_SPD_TESS=56,
