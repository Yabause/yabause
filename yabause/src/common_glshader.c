...
"  }\n"
"  if (pix.layer == 0) { \n"
"    txcoll = getPixel( s_texture0, texCoord, -1 );      \n"
"    txcolll = getPixel( s_texture0, texCoord, -2 );      \n"
"  }\n"
"  if (pix.layer == 1) { \n"
"    txcoll = getPixel( s_texture1, texCoord, -1 );      \n"
"    txcolll = getPixel( s_texture1, texCoord, -2 );      \n"
"  }\n"
"  if (pix.layer == 2) { \n"
"    txcoll = getPixel( s_texture2, texCoord, -1 );      \n"
"    txcolll = getPixel( s_texture2, texCoord, -2 );      \n"
"  }\n"
"  if (pix.layer == 3) { \n"
"    txcoll = getPixel( s_texture3, texCoord, -1 );      \n"
"    txcolll = getPixel( s_texture3, texCoord, -2 );      \n"
"  }\n"
"  if (pix.layer == 4) { \n"
"    txcoll = getPixel( s_texture4, texCoord, -1 );      \n"
"    txcolll = getPixel( s_texture4, texCoord, -2 );      \n"
"  }\n"
"  if (pix.layer == 5) { \n"
"    txcoll = getPixel( s_texture5, texCoord, -1);      \n"
"    txcolll = getPixel( s_texture5, texCoord, -2 );      \n"
"  }\n"
...
"  FBMesh = tmp.mesh;\n"
"  if (screen_nb > 0) vdp2col0 = getPixel( s_texture0, v_texcoord.st, 0 ); \n"
"  if (screen_nb > 1) vdp2col1 = getPixel( s_texture1, v_texcoord.st, 0 ); \n"
"  if (screen_nb > 2) vdp2col2 = getPixel( s_texture2, v_texcoord.st, 0 ); \n"
"  if (screen_nb > 4) vdp2col4 = getPixel( s_texture4, v_texcoord.st, 0 ); \n"
"  if (screen_nb > 3) vdp2col3 = getPixel( s_texture3, v_texcoord.st, 0 ); \n"
"  if (screen_nb > 5) vdp2col5 = getPixel( s_texture5, v_texcoord.st, 0 ); \n"
"  for (int i = 7; i>0; i--) { \n"
...
"vec4 getPixel(sampler2D tex, vec2 st, int deltax) {\n"
" ivec2 addr = ivec2(textureSize(tex, 0) * st);\n"
" vec4 result = texelFetch( tex, addr+ivec2(deltax, 0),0 );\n"
