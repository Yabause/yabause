...
void VIDOGLVdp1NormalSpriteDraw(u8 * ram, Vdp1 * regs, u8* back_framebuffer)
{
  ...
  sprite.vertices[0] = (float)x;
  sprite.vertices[1] = (float)y;
  sprite.vertices[2] = (float)(x + sprite.w);
  sprite.vertices[3] = (float)y;
  sprite.vertices[4] = (float)(x + sprite.w);
  sprite.vertices[5] = (float)(y + sprite.h);
  sprite.vertices[6] = (float)x;
  sprite.vertices[7] = (float)(y + sprite.h);
...
void VIDOGLVdp1ScaledSpriteDraw(u8 * ram, Vdp1 * regs, u8* back_framebuffer)
{
  ...
  sprite.vertices[0] = (float)x;
  sprite.vertices[1] = (float)y;
  sprite.vertices[2] = (float)(x + rw);
  sprite.vertices[3] = (float)y;
  sprite.vertices[4] = (float)(x + rw);
  sprite.vertices[5] = (float)(y + rh);
  sprite.vertices[6] = (float)x;
  sprite.vertices[7] = (float)(y + rh);
