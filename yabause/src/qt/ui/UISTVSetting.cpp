	...
	: UIControllerSetting( core, port, pad, perType, parent )
{
   ...
   setInfos(lInfos);
	...
	mButtons[ tbY_P2 ] = PERPAD_P2_Y;
	mButtons[ tbZ_P2 ] = PERPAD_P2_Z;
	...
	mNames[ PERPAD_P2_Y ] = "Y";
	mNames[ PERPAD_P2_Z ] = "Z";
   ...
   mScanMasks[ PERPAD_P2_Y ] = PERSF_KEY | PERSF_BUTTON | PERSF_HAT;
   mScanMasks[ PERPAD_P2_Z ] = PERSF_KEY | PERSF_BUTTON | PERSF_HAT;
