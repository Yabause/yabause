...
SDL_FRAMEWORK=/Developer/SDKs/MacOSX10.4u.sdk/Library/Frameworks/SDL.framework/Versions/A/SDL
...
cp $SDL_FRAMEWORK $YABAUSE_FRAMEWORKS
...
install_name_tool -change $SDL_FRAMEWORK @executable_path/../Frameworks/SDL $YABAUSE
